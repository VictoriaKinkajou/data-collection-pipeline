...
class Scraper():
    ...
    def __create_id_subfolder(self):
        '''
    ...
    def __save_dictionary(self):
        '''
        This method creates folders, saves the dictionary in a json file and stores it in the product id subfolder.
        '''
